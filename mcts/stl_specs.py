...
def monitor_R2(ways): # rtamt specs for runway R2
	...
	spec.spec = 'eventually( (( (x >-1.5) and (x < 1.5)) and ( (y > -2) and (y < -1) )  and ( (z > 0.72) and (z < 0.96) )  ) and eventually( ((x > 1.5) and (x < 3.0) ) and ((y > -2) and (y < 0.2))  and eventually(((x > 1.3) and (x < 1.5) ) and ((y > -0.2) and (y < 0.2)))))'
