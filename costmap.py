...
class CostMap:
    ...
    def read_csv_folder(self):
        ...
        for file_name in tqdm(glob(full_path)):
            ...
            csv_reader = csv_reader[['x1', 'y1', 'z1']]
    ...
    def creating_dictionaries(self):
        ...
        for altitude in range(0, 6000, 1000):
            for direction in self.directions:
                dict_states = self.data[(self.data['z1'] == altitude) & (self.data['direction'] == direction)].groupby(
                    ['x1', 'y1', 'z1', 'right_direction']).count()['direction'].to_dict()
